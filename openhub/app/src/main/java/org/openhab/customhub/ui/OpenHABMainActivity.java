...
import org.openhab.customhub.core.DocumentHttpResponseHandler;
import org.openhab.customhub.core.NetworkConnectivityInfo;
import org.openhab.customhub.core.NotificationDeletedBroadcastReceiver;
import org.openhab.customhub.core.OpenHABTracker;
import org.openhab.customhub.core.OpenHABTrackerReceiver;
import org.openhab.customhub.model.OpenHABLinkedPage;
import org.openhab.customhub.model.OpenHABSitemap;
import org.openhab.customhub.ui.drawer.OpenHABDrawerAdapter;
...
public class OpenHABMainActivity extends FragmentActivity implements OnWidgetSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AIBaseUrl = mSettings.getString(Constants.PREFERENCE_AIURL, null);
...
//        mDrawerList.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mDrawerTitles));
            ...
            case VOICE_RECOGNITION_REQUEST_CODE:
                ...
                if(resultCode == RESULT_OK) {
                    ...
                    if (!textMatchList.isEmpty()) {
                        ...
                        Log.d("voiceset: ", "Recognized text: " + textMatchList.get(0));
        ...
        try {
            ...
            mAsyncHttpClient.post(this, openHABBaseUrl + "rest/items/" + itemName, se, "text/plain;charset=UTF-8", new AsyncHttpResponseHandler() {
                ...
                public void onFailure(Throwable error, String errorResponse) {
                    Log.e("voiceres", "Got command error " + error.getMessage());
                    if (errorResponse != null)
                        Log.e("voiceres", "Error response = " + errorResponse);
                }
            });
    ...
    public void sendtoaiml(final String phrase) {
        try {
            //String se = URLEncoder.encode(phrase.trim(), "UTF-8");/

            if(irequest.isEmpty()){
                irequest = new ArrayList<String>();
                irequest.add(0, URLEncoder.encode(phrase.trim(), "UTF-8"));
                irequest.add(1,"");
                irequest.add(2,"");
                isireqfirst = true;
            }else{
...
//            speakButton.setText("Voice recognizer not present");
    ...
    private void gcmRegisterBackground() {
        ...
        String aiUrl = mSettings.getString(Constants.PREFERENCE_AIURL, null);
